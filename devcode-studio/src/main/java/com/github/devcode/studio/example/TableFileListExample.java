...
public final class TableFileListExample extends JPanel {
	private TableFileListExample() {
		...
		Object[][] data = { { "test1.jpg", "11111" }, { "test1234.jpg", "  " }, { "test15354.gif", "22222" },
				{ "t.png", "comment" }, { "33333.jpg", "123" }, { "4444444444444444.mpg", "test" },
				{ "5555555555555", "" }, { "test1.jpg", "" } };
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(TableFileListExample::createAndShowGui);
	}
	...
	private static void createAndShowGui() {
		...
		frame.getContentPane().add(new TableFileListExample());
		frame.pack();
...
class FileListTable extends JTable {
	...
	public void updateUI() {
		// [JDK-6788475]
		// Changing to Nimbus LAF and back doesn't reset look and feel of JTable
		// completely
		...
		setDefaultRenderer(Object.class, (table, value, isSelected, hasFocus, row, column) -> r
	...
	private final class RubberBandingListener extends MouseAdapter {
		...
		public void mouseDragged(MouseEvent e) {
			...
			int[] indices = IntStream.range(0, getModel().getRowCount())
					.filter(i -> rb.intersects(getCellRect2(FileListTable.this, i, col))).toArray();
			for (int i : indices) {
	...
	// if (path.intersects(getCellRect2(FileListTable.this, i,
