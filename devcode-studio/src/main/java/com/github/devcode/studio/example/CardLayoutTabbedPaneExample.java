...
public final class CardLayoutTabbedPaneExample extends JPanel {
  private CardLayoutTabbedPaneExample() {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(CardLayoutTabbedPaneExample::createAndShowGui);
  }
  ...
  private static void createAndShowGui() {
    ...
    frame.getContentPane().add(new CardLayoutTabbedPaneExample());
    frame.pack();
